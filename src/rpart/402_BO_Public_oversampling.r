...
PARAM$hs <- makeParamSet(
  makeIntegerParam("minsplit", lower = 100L, upper = 10000L),
  makeIntegerParam("minbucket", lower = 50L, upper = 5000L),
  makeIntegerParam("maxdepth", lower = 6L, upper = 16L),
  makeIntegerParam("corte", lower = 8000L, upper = 10500L),
